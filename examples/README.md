...
| A mixed lot to deal with | `offload` | [mixed-lot.md](mixed-lot.md) |
| Draft a bike ad | `sell` | [bike-listing.md](bike-listing.md) |
| Sell a box of books | `offload` + `sell` | [box-of-books.md](box-of-books.md) |
| "What do I even do with this?" (single item) | `offload` | [single-item-decision.md](single-item-decision.md) |
| US user selling furniture (country adaptation) | `offload` + `sell` | [us-furniture.md](us-furniture.md) |
| UK user with electronics & e-waste | `offload` | [uk-electronics.md](uk-electronics.md) |
